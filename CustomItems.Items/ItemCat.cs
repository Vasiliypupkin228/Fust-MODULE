...
public class ItemCat : CustomKeycard
{
	public override uint Id { get; set; } = 1u;


	public override string Name { get; set; } = "<color=##fff><b>__________ITEMS__________</b></color>";
	...
	public override string KeycardLabel { get; set; } = "__________ПРЕДМЕТЫ__________";


	public override string KeycardName { get; set; } = "__________ПРЕДМЕТЫ__________";
