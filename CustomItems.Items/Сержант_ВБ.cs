...
public class Сержант_ВБ : CustomKeycard
{
	public override uint Id { get; set; } = 1005u;


	public override string Name { get; set; } = "<color=#292929><b>Сержант ВБ</b></color>";
	...
	public override string KeycardLabel { get; set; } = "Сержант Отдела Безопасности";
