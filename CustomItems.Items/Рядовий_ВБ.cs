...
public class Рядовий_ВБ : CustomKeycard
{
	public override uint Id { get; set; } = 1007u;


	public override string Name { get; set; } = "<color=#292929><b>Рядовой ВБ</b></color>";
	...
	public override string KeycardLabel { get; set; } = "Рядовой Отдела Безопасности";
