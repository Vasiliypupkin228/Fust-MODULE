...
public class Капітан_МОГ : CustomKeycard
{
	public override uint Id { get; set; } = 1022u;


	public override string Name { get; set; } = "<color=#00FFFF><b>Карта Капитана МОГ</b></color>";
	...
	public override string KeycardLabel { get; set; } = "Капитан МОГ";
