...
public class Спеціаліст_МОГ : CustomKeycard
{
	public override uint Id { get; set; } = 1020u;


	public override string Name { get; set; } = "<color=#00FFFF><b>Карта Специалиста МОГ</b></color>";
	...
	public override string KeycardLabel { get; set; } = "Специалист МОГ";
