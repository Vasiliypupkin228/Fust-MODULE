...
public class Лейтенант_МОГ : CustomKeycard
{
	public override uint Id { get; set; } = 1021u;


	public override string Name { get; set; } = "<color=#00FFFF><b>Карта Лейтенанта МОГ</b></color>";
	...
	public override string KeycardLabel { get; set; } = "Лейтенант МОГ";
