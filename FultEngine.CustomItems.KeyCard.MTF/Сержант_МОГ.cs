...
public class Сержант_МОГ : CustomKeycard
{
	public override uint Id { get; set; } = 1018u;


	public override string Name { get; set; } = "<color=#00FFFF><b>Карта Сержанта МОГ</b></color>";
	...
	public override string KeycardLabel { get; set; } = "Сержант МОГ";
