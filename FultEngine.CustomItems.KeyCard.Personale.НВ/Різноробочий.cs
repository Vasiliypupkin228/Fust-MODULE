...
public class Різноробочий : CustomKeycard
{
	public override uint Id { get; set; } = 1023u;


	public override string Name { get; set; } = "<color=#ff8c00><b>Карта Разнорабочего</b></color>";
	...
	public override string KeycardLabel { get; set; } = "Разнорабочий";
	...
	public override KeycardPermissions Permissions { get; set; } = (KeycardPermissions)17;
