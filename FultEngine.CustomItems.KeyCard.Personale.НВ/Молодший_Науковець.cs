...
public class Молодший_Науковець : CustomKeycard
{
	public override uint Id { get; set; } = 1015u;


	public override string Name { get; set; } = "<color=#ff8c00><b>Карта Младшего Учёного</b></color>";
	...
	public override string KeycardLabel { get; set; } = "Младший Учёный";
