...
public class Науковець : CustomKeycard
{
	public override uint Id { get; set; } = 1014u;


	public override string Name { get; set; } = "<color=#ff8c00><b>Карта Учёного</b></color>";
	...
	public override string KeycardLabel { get; set; } = "Учёный";
