...
public class Лаборант : CustomKeycard
{
	public override uint Id { get; set; } = 1017u;


	public override string Name { get; set; } = "<color=#ff8c00><b>Карта Лаборанта</b></color>";
	...
	public override string KeycardLabel { get; set; } = "Лаборант";
	...
	public override KeycardPermissions Permissions { get; set; } = (KeycardPermissions)16;
