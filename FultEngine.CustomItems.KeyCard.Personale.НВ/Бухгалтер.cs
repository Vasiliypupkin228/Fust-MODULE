...
public class Бухгалтер : CustomKeycard
{
	public override uint Id { get; set; } = 1025u;


	public override string Name { get; set; } = "<color=#ff8c00><b>Карта Бухгалтер</b></color>";
	...
	public override string KeycardLabel { get; set; } = "Бухгалтер";
