...
public class Керівник_НВ : CustomKeycard
{
	public override uint Id { get; set; } = 1013u;


	public override string Name { get; set; } = "<color=#ff8c00><b>Карта Руководителя НС</b></color>";
	...
	public override string KeycardLabel { get; set; } = "Руководитель НС";
