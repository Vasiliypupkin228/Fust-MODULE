...
public class Карта_Старшого_Інженера : CustomKeycard
{
	public override uint Id { get; set; } = 1009u;


	public override string Name { get; set; } = "<color=#FF8C00><b>Карта Старшего Инженера</b></color>";
	...
	public override string KeycardLabel { get; set; } = "Старший Инженер";
