...
public class Інженер : CustomKeycard
{
	public override uint Id { get; set; } = 1010u;


	public override string Name { get; set; } = "<color=#FF8C00><b>Карта Инженера</b></color>";
	...
	public override string KeycardLabel { get; set; } = "Инженер";
	...
	public override KeycardPermissions Permissions { get; set; } = (KeycardPermissions)40;
